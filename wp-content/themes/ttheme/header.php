...
<head>
    <meta charset="utf-8">
    <title>
        <?php global $page, $paged; $version="?ver=29092014" ; wp_title( '|', true, 'right' ); bloginfo( 'name' ); ?>
    </title>
